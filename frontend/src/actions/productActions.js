...
import { PRODUCT_LIST_SUCCESS,
         ...
         PRODUCT_UPDATE_QTY_REQUEST,
         PRODUCT_UPDATE_QTY_FAIL
        }
    from '../constants/productConstants.js'


export const listProducts = (keyword = '', pageNumber = '', OnAdminProductListScreen = false) => async (dispatch) =>{
    try {
        dispatch({ type: PRODUCT_LIST_REQUEST})
        const { data } = await axios.get(`/api/products?keyword=${keyword}&pageNumber=${pageNumber}&OnAdminProductListScreen=${OnAdminProductListScreen}`)
        dispatch({
